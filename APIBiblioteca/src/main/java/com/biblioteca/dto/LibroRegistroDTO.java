...
public record LibroRegistroDTO(
		// sé que deberían ser atributos privados, pero necesito que la clase sea inmutable
		//por eso uso record en lugar de class, y record no permite modificadores de acceso
    ...
    String dewey,
    String clasificacionDelCongreso,
    String clasificacionDecimalUniversal,
    Set<Long> autoresIds,      
